    ...
    */
    ...
    public abstract class ByteBuffer : Buffer
    {
        ...
        protected byte[] hb
        {
            ...
            set { stream = new MemoryStream(value);}
        }
        protected int offset;

        public ByteBuffer ClearAndSet(byte[] array)
        {
            offset = 0;
            hb = array;
            Limit(array.Length);
        ...
        protected ByteBuffer(int mark, int pos, int lim, int cap,   // package-private
                     byte[] hb, int offset) : base(mark, pos, lim, cap)
        {
            this.hb = hb;
            this.offset = offset;
    ...
    public int compareTo(ByteBuffer that) {
        ...
        //
        protected abstract byte _get(int i);                          // package-private
        protected abstract void _put(int i, byte b);                  // package-private
